...
/* FUll Screen Button */
//I want to be able to enlarge the screen in order for the user to be able to get a larger picture and thus a more clearer video experience to follow along the crafting tutorial. 
// Signifier - I want to click a button
// Affordance - I want to toggle between full screen and default screen 
// Feedback - I'd like to refresh the full-screen button to reflect its current status.

//this is my function to make the video into full screen
function fullscreenButton(){
// check if working
// Although I was trying to just toggle the full screen button, apparently when I wrote the code below, not only did the full screen button suddenly worked, but it also added other functions such as the volume slider, download button, playback speed button, and picture in picture button.
  console.log("fullscreenbutton is working");
}

fullscreenButton.addEventListener('click',fullscreenButton);
